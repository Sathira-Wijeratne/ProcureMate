...
export default function SingleRaisedOrder() {
  ...
  const orderLimit =
    ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_ORDER_LIMIT_VALUE;
  ...
  function approveOrder() {
    ...
    if (response) {
      axios
        .patch(`http://localhost:8070/procurement/handle/approve/${pOrderId}`, {
          status: "Approved",
        })
        .then((res) => {
  ...
  return (
    <div>
      <div className="row" style={{ height: "100%" }}>
        {/* Left tab pane */}
        <div
          id="procurement-raised-orders-tab-pane"
          className="col-3"
        ...
        >
          ...
          <div
            id="procurement-raised-orders-profile-details"
          ...
          <div
            id="procurement-raised-orders-tabs"
        ...
        <div
          id="procurement-raised-orders-content"
          className="col"
          style={{ marginTop: "2%" }}
        >
          <div id="procurement-raised-orders-top">
            ...
            <div id="procurement-raised-orders-date-and-time">
          ...
          <div
            id="procurement-raised-orders-content-body"
            style={{ marginTop: "3%" }}
          >
            <h4>
              <b>
                {
                  ProcurementConstants.SINGLE_RAISED_ORDER_PAGE_PAGE_BODY_HEADING
                }{" "}
                {raisedOrder.pOrderId}
              </b>
            </h4>
            ...
            >
              <div style={{ paddingBottom: "20px" }}>
                <b>
                  {
                    ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_ORDER_PLACED_BY
                  }{" "}
                  :{" "}
                </b>{" "}
                {raisedOrder.siteMngId} - {siteManagerName}
              </div>
              <div style={{ paddingBottom: "20px" }}>
                <b>
                  {
                    ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_ORDER_PLACED_BY_NAME
                  }{" "}
                  :{" "}
                </b>{" "}
                {raisedOrder.siteId} - {location}
              </div>
              <div style={{ paddingBottom: "20px" }}>
                <b>
                  {
                    ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_ORDER_PLACED_BY_DATE
                  }{" "}
                  :{" "}
                </b>{" "}
                {new Date(raisedOrder.date).toLocaleDateString()}
              </div>
            </div>
            <div id="single-raised-order-details" style={{ marginTop: "20px" }}>
              <h4>
                <b>
                  {ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_BODY_HEADING}
                </b>
              </h4>
                ...
                <table className="table" style={{ width: "70%" }}>
                  <thead>
                    <tr>
                      <th>
                        {
                          ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_TABLE_HEADER_NAME
                        }
                      </th>
                      <th>
                        {
                          ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_TABLE_HEADER_QUANTITY
                        }
                      </th>
                      <th>
                        {
                          ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_TABLE_HEADER_UNIT_PRICE
                        }
                      </th>
                      <th>
                        {
                          ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_TABLE_HEADER_TOTAL
                        }
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {raisedOrder.qty} {raisedOrder.uom}
                      </td>
                      <td>
                        {ProcurementConstants.CURRENCY}{" "}
                        {parseFloat(raisedOrder.unitPrice).toFixed(2)}
                      </td>
                      <td>
                        {ProcurementConstants.CURRENCY}{" "}
                        {parseFloat(raisedOrder.amount).toFixed(2)}
                      </td>
                    </tr>
                    <tr>
                      <td></td>
                      ...
                      <td>
                        <b>
                          {
                            ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_TABLE_GROSS_TOTAL
                          }
                        </b>
                      </td>
                      <td
                        style={{
                          color:
                            raisedOrder.amount > orderLimit ? "red" : "black",
                        }}
                      >
                        <b>
                          {ProcurementConstants.CURRENCY}{" "}
              ...
              >
                <b>
                  {ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_ORDER_LIMIT}
                  <b
                    style={{
                      color: raisedOrder.amount > orderLimit ? "red" : "black",
                    }}
                  >
                    {ProcurementConstants.CURRENCY}{" "}
                    {parseFloat(
              ...
              <div style={{ marginTop: "25px", marginBottom: "25px" }}>
                <div>
                  <b>
                    {
                      ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_REJECT_REASON
                    }
                  </b>
                  <input
                    ...
                    type="text"
                    placeholder={
                      ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_REJECT_REASON_HINT
                    }
                    onChange={(e) => {
              ...
              >
                <button
                  ...
                  style={{
                    display: raisedOrder.amount > orderLimit ? "none" : "",
                  }}
                >
                  {
                    ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_APPROVE_BUTTON
                  }
                </button>
                <button
                  ...
                  onClick={rejectOrder}
                >
                  {ProcurementConstants.SINGLE_RAISED_ORDERS_PAGE_REJECT_BUTTON}
                </button>
              </div>
            </div>
          </div>
