...
export default function RaisedOrders() {
  ...
  function fetchSpecificRaisedOrder(pOrderId, location) {
    ...
    window.location.replace(
      `/procurementstaffhome/raisedorders/get/${pOrderId}/${location}`
    );
  }
  ...
  function searchApprovedOrders(orderId) {
    ...
    if (orderId !== "") {
      const filteredOrders = raisedOrdersForSearch.filter((order) =>
        ...
        >
          ...
          >
            ...
            >
              <h2>
                <b>
                  {ProcurementConstants.RAISED_ORDERS_PAGE_PAGE_BODY_HEADING}
                </b>
              </h2>
              <div
                ...
                <tbody>
                  {raisedOrders.map((order) => (
                    <tr
                      ...
                      key={order.pOrderId}
                      onClick={() =>
                        fetchSpecificRaisedOrder(order.pOrderId, order.location)
                      }
                    >
