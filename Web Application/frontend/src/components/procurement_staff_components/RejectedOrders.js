...
export default function RejectedOrders() {
  ...
  function searchRejectedOrders(orderId) {
    ...
    if (orderId !== "") {
      const filteredOrders = rejectedOrdersForSearch.filter((order) =>
  ...
  return (
    <div>
      <div className="row" style={{ height: "100%" }}>
        {/* Left tab pane */}
        <div
          id="procurement-rejected-orders-tab-pane"
          className="col-3"
        ...
        >
          ...
          <div
            id="procurement-rejected-orders-profile-details"
          ...
          <div
            id="procurement-rejected-orders-tabs"
        ...
        <div
          id="procurement-rejected-orders-content"
          className="col"
          style={{ marginTop: "2%" }}
        >
          <div id="procurement-rejected-orders-top">
            ...
            <div id="procurement-rejected-orders-date-and-time">
          ...
          <div
            id="procurement-rejected-orders-content-body"
            style={{ marginTop: "3%" }}
          >
            <div
              style={{
            ...
            >
              <h2 style={{ margin: 0 }}>
                <b>
                  {ProcurementConstants.REJECTED_ORDERS_PAGE_PAGE_BODY_HEADING}
                </b>
              </h2>
              <div
              ...
              >
                ...
                <input
                  ...
                  maxLength={7}
                  onChange={(e) => {
                    searchRejectedOrders(e.target.value);
                  }}
                />
              </div>
            </div>
                ...
                <tbody>
                  {rejectedOrders.map((order) => (
                    <tr key={order.pOrderId}>
                      ...
                      <td style={{ wordWrap: "break-word", maxWidth: "210px" }}>
                        {order.rejectReason}
                      </td>
