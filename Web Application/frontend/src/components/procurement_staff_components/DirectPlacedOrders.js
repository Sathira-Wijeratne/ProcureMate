...
export default function DirectPlacedOrders() {
  ...
  function searchDirectOrders(orderId) {
    ...
    if (orderId !== "") {
      const filteredOrders = directOrdersForSearch.filter((order) =>
  ...
  return (
    <div>
      <div className="row" style={{ height: "100%" }}>
        {/* Left tab pane */}
        <div
          id="procurement-direct-orders-tab-pane"
          className="col-3"
          style={{ backgroundColor: "#b9bdba" }}
        >
          <div
          ...
          <div
            id="procurement-direct-orders-profile-details"
          ...
          <div
            id="procurement-direct-orders-tabs"
        ...
        <div
          id="procurement-direct-orders-content"
          className="col"
          style={{ marginTop: "2%" }}
        >
          <div id="procurement-direct-orders-top">
            ...
            <div id="procurement-direct-orders-date-and-time">
          ...
          <div
            id="procurement-direct-orders-content-body"
            style={{ marginTop: "3%" }}
          >
            <div
              style={{
            ...
            >
              <h2>
                <b>
                  {
                    ProcurementConstants.DIRECT_PLACED_ORDERS_PAGE_PAGE_BODY_HEADING
                  }
                </b>
              </h2>
              <div
              ...
              >
                ...
                <input
                  ...
                  maxLength={7}
                  onChange={(e) => {
                    searchDirectOrders(e.target.value);
                  }}
                />
              </div>
            </div>
